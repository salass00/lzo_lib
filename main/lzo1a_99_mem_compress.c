...
/****** lzo/main/lzo1a_99_mem_compress ******************************************
*
*   NAME
*      lzo1a_99_mem_compress -- Description
*
*   SYNOPSIS
*      uint32 lzo1a_99_mem_compress(void);
*
*   FUNCTION
*
*   INPUTS
...
uint32 _main_lzo1a_99_mem_compress(struct LZOIFace *Self) {

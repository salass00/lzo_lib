...
/****** lzo/main/lzo1z_999_mem_compress ******************************************
*
*   NAME
*      lzo1z_999_mem_compress -- Description
*
*   SYNOPSIS
*      uint32 lzo1z_999_mem_compress(void);
*
*   FUNCTION
*
*   INPUTS
...
uint32 _main_lzo1z_999_mem_compress(struct LZOIFace *Self) {

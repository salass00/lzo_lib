...
/****** lzo/main/lzo1x_999_mem_compress ******************************************
*
*   NAME
*      lzo1x_999_mem_compress -- Description
*
*   SYNOPSIS
*      uint32 lzo1x_999_mem_compress(void);
*
*   FUNCTION
*
*   INPUTS
...
uint32 _main_lzo1x_999_mem_compress(struct LZOIFace *Self) {

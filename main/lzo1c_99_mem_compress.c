...
/****** lzo/main/lzo1c_99_mem_compress ******************************************
*
*   NAME
*      lzo1c_99_mem_compress -- Description
*
*   SYNOPSIS
*      uint32 lzo1c_99_mem_compress(void);
*
*   FUNCTION
*
*   INPUTS
...
uint32 _main_lzo1c_99_mem_compress(struct LZOIFace *Self) {

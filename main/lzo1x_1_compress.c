...
/****** lzo/main/lzo1x_1_compress ******************************************
*
*   NAME
*      lzo1x_1_compress -- Description
*
*   SYNOPSIS
*      int32 lzo1x_1_compress(CONST_APTR src, uint32 src_len, APTR dst, 
...
int32 _main_lzo1x_1_compress(struct LZOIFace *Self, CONST_APTR src, uint32 src_len,

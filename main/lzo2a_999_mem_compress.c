...
/****** lzo/main/lzo2a_999_mem_compress ******************************************
*
*   NAME
*      lzo2a_999_mem_compress -- Description
*
*   SYNOPSIS
*      uint32 lzo2a_999_mem_compress(void);
*
*   FUNCTION
*
*   INPUTS
...
uint32 _main_lzo2a_999_mem_compress(struct LZOIFace *Self) {

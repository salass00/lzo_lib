...
/****** lzo/main/lzo1x_decompress ******************************************
*
*   NAME
*      lzo1x_decompress -- Description
*
*   SYNOPSIS
*      int32 lzo1x_decompress(CONST_APTR src, uint32 src_len, APTR dst, 
...
int32 _main_lzo1x_decompress(struct LZOIFace *Self, CONST_APTR src, uint32 src_len,

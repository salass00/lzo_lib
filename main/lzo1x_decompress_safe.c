...
/****** lzo/main/lzo1x_decompress_safe ******************************************
*
*   NAME
*      lzo1x_decompress_safe -- Description
*
*   SYNOPSIS
*      int32 lzo1x_decompress_safe(CONST_APTR src, uint32 src_len, APTR dst, 
...
int32 _main_lzo1x_decompress_safe(struct LZOIFace *Self, CONST_APTR src, uint32 src_len,
